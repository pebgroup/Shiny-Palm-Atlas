...
df_full$label <- paste("<p>", "Species =", df_full$species, "</p>",
                       "<p>", "Locality =", df_full$locality, "</p>",
                       "<p>", "Coordinate uncertainty in meters =", df_full$coordinateUncertaintyInMeters, "</p>"
                       )
